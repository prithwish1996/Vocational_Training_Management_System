    ...
    else
    {
      $page1 = ($page1 * $p)-$p;
				...
				//Inserting into the Database
					...
					$q1 = mysqli_query($link,$query1);
					echo "<br><br><div id='div1' style='overflow:scroll; width:98%'><table id='edit_page_table' border='4'><tr><th><h3>VT_NO.</h3></th><th><h3>SESSION</h3></th><th><h3>NAME</h3></th><th><h3>COLLEGE</h3></th><th><h3>BRANCH</h3></th><th><h3>SEM</h3></th><th><h3>YEAR</h3></th>
...
for($i=1; $i<=$count; ++$i)
{
  echo'<li><a href="vt_form_view2.php?pages='.$i.'" >'.$i.'</a></li>';
 }} ?>
